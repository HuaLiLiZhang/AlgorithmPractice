...
public class _134GasStation {
    public static void main(String[] args) {
        Solution solution = new _134GasStation().new Solution();
    }
    ...
    class Solution {
        ...
        public int canCompleteCircuit_1(int[] gas, int[] cost) {
            ...
            //如果累加的最小值是负数，汽车就要从非0节点出发(因为从0开始出现了负数，依然是到不了终点的)，所以应该从后向前，
        ...
        //时间复杂度O(n^2)
        //空间复杂度O(n)
        public int canCompleteCircuit_n2(int[] gas, int[] cost) {
            if (gas == null || cost == null || gas.length != cost.length) {
                return -1;
            }
