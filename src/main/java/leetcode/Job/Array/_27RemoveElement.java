...
public class _27RemoveElement {
    public static void main(String[] args) {
        Solution solution = new _27RemoveElement().new Solution();
    }
    ...
    class Solution {
        /**
         * @Description: 暴力解法：两次循环遍历，一个for循环遍历数组元素 ，第二个for循环更新数组，因为不需要考虑数组中超出新长度后面的元素，直接覆盖即可
         * @Param: [nums, val]
         */
        ...
        /**
         * @Description: 快慢指针，一次循环，时间复杂度O(N) ：「通过一个快指针和慢指针在一个for循环下完成两个for循环的工作。」
         * @Param: [nums, val]
         */
